const useEstimateCalculations = (estimate) => {
	...
	// modify the timestamps before returning: 
	estimate.date_created = estimate.date_created.toISOString().substring(0, 10);
	estimate.anticipated_first_pour_date = estimate.anticipated_first_pour_date.toISOString().substring(0, 10);
