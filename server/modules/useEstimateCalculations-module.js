const useEstimateCalculations = (estimate, options = null) => {
	...
	estimate.date_created = estimate.date_created.toISOString().split('T')[0];
	estimate.anticipated_first_pour_date = estimate.anticipated_first_pour_date.toISOString().split('T')[0];
