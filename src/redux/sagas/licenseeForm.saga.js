...
function* handleCalculatedEstimate(action) {
	...
	// var past_date = new Date(action.payload.estimate.date_created);
	var past_date = new Date('2022-12-10');

	var current_date = new Date();

	var difference = (current_date.getFullYear() * 12 + current_date.getMonth()) - (past_date.getFullYear() * 12 + past_date.getMonth());
	console.log(`Ryan Here: handleCalculatedEstimate`, { difference, past_date, current_date });
