...
export default function AdminUpdateMaterials() {
	...
	const handleEditSubmit = ({ id, field, value }) => {
		console.log(`Ryan Here: handleEditSubmit`, {id, field, value});
		// product_id argument is the db product_id of the row being edited and value is the new value after submitting the edit
		dispatch({
			type: 'UPDATE_PRODUCT', 
			payload: {
				product_id: id,
	...
	return (
		<div>
			...
			{/* <TextField product_id="outlined-basic" label="Add New Material" variant="outlined" value={productInput} onChange={handleProductInputChange}/>
      <TextField product_id="outlined-basic" label="Add New Price" variant="outlined" value={productPriceInput} onChange={handlePriceInputChange}/>
